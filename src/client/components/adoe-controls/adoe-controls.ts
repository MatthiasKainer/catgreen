...
import { styles } from "./adoe-controls.styles";

import "./adoe-controls-name";
import "./adoe-controls-filter";
import "./adoe-controls-reload";
...
export default pureLit(
  ...
  async () => {
    ...
    return html`
      <adoe-controls-name
        label="${texts["filter-name"].label}"
        placeholder="${texts["filter-name"].placeholder}"
      >
      ...
      <adoe-controls-filter
        label="${texts["filter-results"].label}"
        placeholder="${texts["filter-results"].placeholder}"
      >
        <adoe-tooltip tooltip="${texts["filter-results"].tooltip}">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            id="help"
            width="20px"
      ...
      <adoe-toggle @checked=${(e: CustomEvent) => showInProgress.set(e.detail)}
        >${texts["filter-progress"]}</adoe-toggle
      >
